...
function agregarItemAlFinalDelArray(array, elemento) {
  ...
  // y devuelve el array
  // Tu código:
  //let nuevoArr = array.push(elemento);
  //return nuevoArr[array.length[-1]];
  array.push(elemento);
  return array;
}
...
function mayorACien(array) {
  ...
  var mayoresCien = [];
  for (let index = 0; index < array.length; index++) {
    if(array[index]>100) mayoresCien.push(array[index])
